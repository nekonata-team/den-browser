...
This model originates from Niri-style spatial window management: Niri workspaces map loosely to desks, and Niri windows map loosely to boards. The mapping is intentionally not exact; Den Browser uses its own paper-workspace language so browser concepts do not collapse back into tabs and pages.
