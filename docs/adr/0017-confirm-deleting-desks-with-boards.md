...
After deletion, Den presents the previous Desk when one exists; deleting the first Desk presents the following Desk. If a pending deletion is confirmed after the user switches Desks, the current Desk remains presented.
