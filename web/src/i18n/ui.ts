  ...
  en: {
    ...
    features: {
      ...
      items: [
        ...
        {
          icon: 'ubol',
          title: 'Built-in Content Blocking (uBOL)',
          description: ['Bundled with uBlock Origin Lite out of the box. Blocks intrusive ads, popups, and trackers for a lightweight, distraction-free web experience.'] satisfies InlinePart[],
        },
      ],
    },
    cta: {
  ...
  ja: {
    ...
    features: {
      ...
      items: [
        ...
        {
          icon: 'ubol',
          title: 'uBlock Origin Lite 内蔵',
          description: ['uBlock Origin Lite（uBOL）を標準搭載。不要な広告やトラッカーを効果的に遮断し、軽快でクリーンなブラウジング環境を提供します。'] satisfies InlinePart[],
        },
      ],
    },
    cta: {
